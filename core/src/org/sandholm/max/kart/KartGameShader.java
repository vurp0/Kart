...
public class KartGameShader extends BaseShader {
    public static class Config {
        ...
        /** Set to 0 to disable culling, -1 to inherit from {@link KartGameShader#defaultCullFace} */
        public int defaultCullFace = -1;
        /** Set to 0 to disable depth test, -1 to inherit from {@link KartGameShader#defaultDepthFunc} */
...
/*        public final static Setter environmentCubemap = new LocalSetter() {
    ...
    public KartGameShader(final Renderable renderable) {
        this(renderable, new Config());
    }

    public KartGameShader(final Renderable renderable, final Config config) {
        this(renderable, config, createPrefix(renderable, config));
    }

    public KartGameShader(final Renderable renderable, final Config config, final String prefix) {
        this(renderable, config, prefix, config.vertexShader != null ? config.vertexShader : getDefaultVertexShader(),
                config.fragmentShader != null ? config.fragmentShader : getDefaultFragmentShader());
    }

    public KartGameShader(final Renderable renderable, final Config config, final String prefix, final String vertexShader,
                          final String fragmentShader) {
        this(renderable, config, new ShaderProgram(prefix + vertexShader, prefix + fragmentShader));
    }

    public KartGameShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
    ...
    public boolean equals (Object obj) {
        return (obj instanceof KartGameShader) ? equals((KartGameShader)obj) : false;
    }
